...
# (str) Package name
package.name = marblegranitemanager

# (str) Package domain (needed for android/ios packaging)
package.domain = com.marblegranite.manager
...
requirements = python3,kivy==2.3.0,kivymd,arabic_reshaper,python-bidi,reportlab,peewee,requests,plyer,matplotlib,pillow
...
# (list) Permissions
android.permissions = WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE,INTERNET,CAMERA,ACCESS_NETWORK_STATE,WAKE_LOCK
